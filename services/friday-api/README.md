# FRIDAY Backend API (v1.2)

The backend service acts as the decoupled "brain" for the FRIDAY AI Operating System, incorporating the official Google Gemini SDK, prompt construction tools, customizable model config templates, memory log systems, and a semantic project knowledge search engine.
...
│   ├── friday/        # Intent enums, orchestrator pipelines, prompt templates, vector databases, workspace manager, document chunkers
...
### POST `/ask`
Submit prompts to FRIDAY. Handles confirmation verification loops for destructive tasks.
...
- **Response**:
  ```json
  {
    ...
    "results": [
      {
        "id": "/home/warlock/ORION/services/friday-api/app/friday/orchestrator.py#chunk2",
        "document": "class FridayOrchestrator:\n    # ...",
        "metadata": {
          "file_path": "/home/warlock/ORION/services/friday-api/app/friday/orchestrator.py",
          "project_name": "friday-api",
          "file_type": "py",
          "chunk_index": 2
        },
        "score": 0.895
