...
class EventBus:
    ...
    def __init__(self) -> None:
        self._subscribers: Dict[str, List[tuple[Callable[[FridayEvent], Any], int]]] = {}
        self._middlewares: List[Callable[[FridayEvent], Optional[FridayEvent]]] = []
        self._background_tasks: Set[asyncio.Task] = set()

    def add_middleware(self, middleware: Callable[[FridayEvent], Optional[FridayEvent]]) -> None:
        """
    ...
    def subscribe(self, event_type: str, callback: Callable[[FridayEvent], Any], priority: int = 100) -> None:
        """
    ...
    def unsubscribe(self, event_type: str, callback: Callable[[FridayEvent], Any]) -> None:
    ...
    async def publish(self, event: FridayEvent) -> None:
        ...
        matching_handlers: List[tuple[Callable[[FridayEvent], Any], int]] = []
        ...
        groups: Dict[int, List[Callable[[FridayEvent], Any]]] = {}
    ...
    def publish_background(self, event: FridayEvent) -> None:
    ...
    async def _background_publish(self, event: FridayEvent) -> None:
        try:
