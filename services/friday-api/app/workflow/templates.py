"""
Built-in Workflow Templates for FRIDAY.
...
def build_workflow_from_template(
    ...
    # -----------------------------------------------------------------
        ...
        n2 = WorkflowNode(
            ...
            type=WorkflowNodeType.DESKTOP_ACTION.value,
            depends_on=["notify_start"],
            inputs={"action": "show_notification", "message": "FRIDAY Workflow Active", "title": "FRIDAY"},
        )
        n3 = WorkflowNode(
            id="open_folder",
        ...
        n4 = WorkflowNode(
            ...
            inputs={"action": "write_clipboard", "text": "FRIDAY Workflow Engine v3.4"},
        )
        n5 = WorkflowNode(
            id="delay",
            name="Wait 2s",
