...
from app.friday.vectordb import VectorStore, VectorDB
from app.friday.knowledge_embeddings import EmbeddingProvider, GeminiEmbeddingProvider
from app.friday.knowledge_document import Document, DocumentParser, ChunkManager
from app.friday.knowledge_retriever import SemanticRetriever, HybridRetriever, KnowledgeRanker
from app.friday.knowledge_context import CitationManager, ContextAssembler
from app.events.events import FridayEvent

# Event models
class DocumentIndexed(FridayEvent):
...
class KnowledgeFailed(FridayEvent):
...
class KnowledgeEngine:
    ...
    async def search(self, query: str, n_results: int = 5) -> List[Dict[str, Any]]:
        if not self._manager:
            ...
            from app.friday.vectordb import JSONVectorStore
            persist_dir = self._persist_dir or ".friday_kb"
    ...
    def on_memory_updated(self, event: FridayEvent) -> None:
