...
class AgentStatusChanged(FridayEvent):
...
class AgentTaskCreated(FridayEvent):
...
class AgentTaskCancelled(FridayEvent):
    def __init__(self, task_id: str, agent_id: str) -> None:
...
class AgentTaskTimeout(FridayEvent):
...
class AgentMessageReceived(FridayEvent):
...
class AgentJobScheduled(FridayEvent):
...
class AgentJobCompleted(FridayEvent):
...
class AgentCircuitBreakerTripped(FridayEvent):
...
class AgentDeadLetterMessage(FridayEvent):
