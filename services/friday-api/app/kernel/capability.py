...
class FridayCapabilityRegistry:
    ...
    def __init__(self) -> None:
        self._capabilities: Dict[str, FridayCapabilityInfo] = {}
    ...
    def register_capability(self, name: str, module_name: str, description: str, schema: Optional[Dict[str, Any]] = None) -> None:
        ...
        self._capabilities[name] = FridayCapabilityInfo(name, module_name, description, schema)
    ...
    def get_capability(self, name: str) -> Optional[FridayCapabilityInfo]:
