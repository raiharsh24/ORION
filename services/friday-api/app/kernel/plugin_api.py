...
class FridayPlugin(ABC):
    """
    Abstract base class defining the standard extension interface for all FRIDAY plugins.
    Allows independent third-party code to integrate with FRIDAY core lifecycles and event bus.
    """
    @abstractmethod
