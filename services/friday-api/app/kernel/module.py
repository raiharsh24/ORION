...
class FridayModuleRegistry:
    ...
    def __init__(self) -> None:
        ...
        self._metadata: Dict[str, FridayModuleMetadata] = {}
    ...
    def register_module(
        ...
        meta = FridayModuleMetadata(name, version, deps)
    ...
    def get_metadata(self, name: str) -> Optional[FridayModuleMetadata]:
