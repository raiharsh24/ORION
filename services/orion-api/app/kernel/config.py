...
class OrionKernelConfig(BaseModel):
    """
    Global configuration model schema for the central ORION system kernel.
    ...
    @classmethod
    def load_defaults(cls) -> 'OrionKernelConfig':
        """
