...
class OrionTelemetryLogger:
    ...
    def log(level: str, module: str, message: str, **kwargs: Any) -> None:
        ...
        context = OrionTelemetryLogger.get_trace_context()
        log_data = {
            "module_name": module,
    ...
    def info(module: str, message: str, **kwargs: Any) -> None:
        OrionTelemetryLogger.log("INFO", module, message, **kwargs)

    @staticmethod
    def debug(module: str, message: str, **kwargs: Any) -> None:
        OrionTelemetryLogger.log("DEBUG", module, message, **kwargs)

    @staticmethod
    def warning(module: str, message: str, **kwargs: Any) -> None:
        OrionTelemetryLogger.log("WARNING", module, message, **kwargs)

    @staticmethod
    def error(module: str, message: str, **kwargs: Any) -> None:
        OrionTelemetryLogger.log("ERROR", module, message, **kwargs)
